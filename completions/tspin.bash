_tspin() {
    ...
    case "${cmd}" in
        tspin)
            opts="-f -p -c -h -V --follow --print --config-path --listen-command --highlight --enable --disable --disable-builtin-keywords --generate-bash-completions --generate-fish-completions --generate-zsh-completions --help --version [FILE]"
